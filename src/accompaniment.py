...
class ChordGenerator:
    def __init__(self, key, scale_type):
        ...
        # Pre-calculate full scale range for chord generation
        self.full_scale_range = get_scale_notes(key, scale_type, start_octave=3, end_octave=5)
    ...
    def get_chord_notes(self, degree, octave_offset=0):
        ...
        for idx in chord_indices:
            if idx < len(self.full_scale_range):
                midi_notes.append(self.full_scale_range[idx] + (octave_offset * 12))
